...
public class Despesa extends RegistroFinanceiro implements PossuiData{
	...
	public Despesa(int codigoUsuario, String descricao, double valor, Frequencia frequencia, LocalDate data) {
		super(codigoUsuario, descricao, valor);
		this.frequencia = frequencia;
		this.data = data;
	}

	public Despesa(int codigo, int codigoUsuario, String descricao, double valor, Frequencia frequencia,
			LocalDate data) {
