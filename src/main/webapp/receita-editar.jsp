...
<title>SevenCows | Editar Receita</title>
...
<body class="bg-success text-dark bg-opacity-10">
	...
	<div
		...
		<h2 class="my-4">Editar Receita</h2>
		...
		<form action="ReceitaController" method="post">
			...
			<input type="hidden" name="acao" value="editar"> <input
				type="hidden" value="${receita.codigo}" name="codigo"> <input
				type="hidden" value="${receita.codigoUsuario}" name="codigoUsuario">

			<div class="mb-3">
				<label for="id-descricao" class="form-label">Descrição</label> <input
					type="text" class="form-control" id="id-descricao" name="descricao"
					onfocus="this.value='';" value="${receita.descricao}" required>
			</div>

			<div class="mb-3">
				<label for="id-data" class="form-label">Data</label> <input
					type="date" class="form-control" id="id-data" name="data" required value="${data}">
			</div>

			<div class="mb-3">
				<label for="id-valor" class="form-label">Valor (R$)</label> <input
					type="number" class="form-control" id="id-valor" name="valor"
					onfocus="this.value='';" value="${receita.valor}" step="0.01"
					inputmode="decimal" required min="0.00">
			</div>
